...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.resize(559, 519)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.MinimumExpanding, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(MainWindow.sizePolicy().hasHeightForWidth())
        MainWindow.setSizePolicy(sizePolicy)
        MainWindow.setMinimumSize(QtCore.QSize(559, 519))
        MainWindow.setMaximumSize(QtCore.QSize(559, 519))
        MainWindow.setIconSize(QtCore.QSize(24, 12))
        self.centralwidget = QtWidgets.QWidget(MainWindow)
        self.centralwidget.setObjectName("centralwidget")
        self.Title_lable = QtWidgets.QLabel(self.centralwidget)
        self.Title_lable.setGeometry(QtCore.QRect(10, 20, 441, 51))
        font = QtGui.QFont()
        ...
        self.Result_PTE.setGeometry(QtCore.QRect(10, 210, 351, 261))
        ...
        self.pushButton.setGeometry(QtCore.QRect(440, 410, 101, 61))
        font = QtGui.QFont()
        ...
        self.pushButton.clicked.connect(MainWindow.StartDownload) # type: ignore
        self.actionSaveFolder.triggered.connect(MainWindow.Setting) # type: ignore
        QtCore.QMetaObject.connectSlotsByName(MainWindow)

    def retranslateUi(self, MainWindow):
        _translate = QtCore.QCoreApplication.translate
        MainWindow.setWindowTitle(_translate("MainWindow", "MainWindow"))
        self.Title_lable.setText(_translate("MainWindow", " YouTube Downloader Lite 1.5"))
